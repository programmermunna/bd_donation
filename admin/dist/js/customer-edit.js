...
const edit_customer = customers.find((c) => c.id === get_id);
...
edit_customer_form.innerHTML = `
    <div>
    <label>Full Name</label>
    <input type="text" placeholder="Full name" class="input" value="${edit_customer.name}" />
    </div>
    <div>
    <label>Email</label>
    <input type="text" placeholder="Email" class="input" value="${edit_customer.email}" />
    </div>
    <div>
    <label>Phone</label>
    <input type="text" placeholder="Phone" class="input" value="${edit_customer.phone}" />
    </div>
    <div>
    <label>Address</label>
    <input type="text" placeholder="Address" class="input" value="${edit_customer.address}" />
    </div>
    <div>
    <label>Shop Name</label>
    <input type="text" placeholder="Shop Name" class="input" value="${edit_customer.shop_name}" />
    </div>
    <div>
    <label>Account Holder</label>
    <input type="text" placeholder="Account Holder" class="input" value="${edit_customer.account_holder}" />
    </div>
    <div>
    <label>Account Number</label>
    <input type="text" placeholder="Account Number" class="input" value="${edit_customer.account_number}" />
    </div>
    <div>
    <label>Bank Name</label>
    <input type="text" placeholder="Bank Name" class="input" value="${edit_customer.bank_name}" />
    </div>
    <div>
    <label>Branch Name</label>
    <input type="text" placeholder="Branch Name" class="input" value="${edit_customer.branch_name}" />
    </div>
    <div>
    <label>City</label>
    <input type="text" placeholder="City" class="input" value="${edit_customer.city}" />
    </div>
    <div>
    <label for="change_photo">
    <img width="80" height="80" class="rounded" src="${edit_customer.image}"/>
...
edit_customer_form.addEventListener("submit", function (e) {
  e.preventDefault();
