...
let notifications_overlay = document.getElementById("notifications_overlay");
const notifications_button = document.getElementById("notifications_button");
...
(() => {
  function toggle() {
    ...
    if (show_notifications) {
      ...
      notifications_overlay.style.display = "block";
    } else {
  ...
  notifications_overlay.addEventListener("click", () => {
    toggle();
  });
})();
